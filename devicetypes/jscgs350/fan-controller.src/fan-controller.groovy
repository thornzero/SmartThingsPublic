metadata {
	...
	definition (name: "Fan Controller", namespace: "jscgs350", author: "Craig L.") {
     ...
     tiles (scale:2) {
		multiAttributeTile(name: "switch", type: "lighting", width: 6, height: 4, canChangeIcon: true) {
        	tileAttribute ("device.switch", key: "PRIMARY_CONTROL") {
				attributeState "onHigh", label:'High', action:"switch.off", icon:"st.switches.switch.on", backgroundColor:"#a1dd73", nextState: "turningOff"
            	attributeState "onMed", label:'Med', action:"switch.off", icon:"st.switches.switch.on", backgroundColor:"#37a144", nextState: "turningOff"
            	attributeState "onLow", label:'Low', action:"switch.off", icon:"st.switches.switch.on", backgroundColor:"#006f56", nextState: "turningOff"
